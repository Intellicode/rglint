...
| [spec-043](implemented/spec-043.md) | no-one-place-fragments | `[x]` |
...
| [spec-046](implemented/spec-046.md) | relay-connection-types | `[x]` |
| [spec-047](implemented/spec-047.md) | relay-edge-types | `[x]` |
| [spec-048](implemented/spec-048.md) | relay-page-info | `[x]` |
...
| [spec-063](implemented/spec-063.md) | Default recommended config preset | `[x]` |
...
| [spec-065](implemented/spec-065.md) | Benchmarks (criterion) | `[x]` |
| [spec-066](implemented/spec-066.md) | Release binary & cargo-binstall | `[x]` |
